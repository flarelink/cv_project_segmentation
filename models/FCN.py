# =============================================================================
# FCN.py - FCN implementations taken directly from reference
# References:
...
__all__ = ['FCN32s', 'FCN16s', 'FCN8s', 'FCNs']

# more accurate at lower FCN numbers, so FCN8 is more pixel accurate
# while FCNs concatenates all
